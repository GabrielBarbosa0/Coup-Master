const CACHE_NAME = 'coup-master-pwa-v181';
...
const APP_SHELL = [
  ...
  './manifest.webmanifest?v=custom-logo-v4',
  './favicon.ico',
  './favicon.png',
  './css/loading.css',
  './css/chat.css',
  ...
  './js/ui/first-interaction-fullscreen.js?v=2',
  ...
  './assets/img/logo/coup-master-circulo-192x192.png?v=custom-logo-v4',
  './assets/img/logo/coup-master-circulo-512x512.png?v=custom-logo-v4',
  './assets/img/logo/favicon-coup-master-circulo.png?v=custom-logo-v4',
