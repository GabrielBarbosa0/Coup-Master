const CACHE_NAME = 'coup-master-pwa-v133';
...
const APP_SHELL = [
  ...
  './manifest.webmanifest?v=custom-logo-v3',
  './favicon.ico',
  './favicon.png',
  './css/loading.css',
  './css/chat.css',
  ...
  './assets/img/logo/coup-master-192x192.png?v=custom-logo-v3',
  './assets/img/logo/coup-master-512x512.png?v=custom-logo-v3',
